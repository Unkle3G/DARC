...
[
  ...
  {"id": "L13", "tier": "aux", "weight": 1.0, "name_zh": "人工智能", "name_en": "AI in hepatology",
   "terms_en": ["artificial intelligence", "machine learning", "deep learning",
                "digital pathology ai", "ai-based", "algorithm-derived", "foundation model",
                "computer-aided diagnosis", "radiomics"],
   "terms_zh": ["人工智能", "机器学习", "深度学习", "数字病理", "影像组学", "辅助诊断"],
   "note": "Auxiliary line with full weight (1.0). The weight exception does not lift the main-line requirement for the daily report."},

  {"id": "L14", "tier": "aux", "name_zh": "无创诊断与生物标志物", "name_en": "Non-invasive diagnostics",
   "terms_en": ["fibroscan", "transient elastography", "liver stiffness", "mre",
                "fib-4", "elf test", "cap score", "mrs-pdff", "pro-c3", "biomarker panel"],
   "terms_zh": ["瞬时弹性成像", "肝脏硬度", "无创诊断", "生物标志物", "肝纤维化四项"]},

  {"id": "L15", "tier": "aux", "name_zh": "肠肝轴与微生态", "name_en": "Gut-liver axis & microbiome",
   "terms_en": ["gut-liver axis", "microbiome", "microbiota", "bile acid signalling", "fxr agonist"],
   "terms_zh": ["肠肝轴", "肠道菌群", "微生态", "胆汁酸"]},
...
[
  ...
  {"name": "Ipsen", "ticker": "IPN", "market": "eu", "tier": 2, "lines": ["L4", "L11"]},
  ...
  {"name": "Roche", "ticker": "ROG", "market": "eu", "tier": 2, "lines": ["L1", "L6"]},
