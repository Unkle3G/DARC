...
[
  ...
  {"id": "L15", "tier": "aux", "name_zh": "肠肝轴与微生态", "name_en": "Gut-liver axis & microbiome",
   ...
   "gated_terms_en": ["microbiome", "microbiota", "dysbiosis"],
   "gated_terms_zh": ["肠道菌群", "微生态", "菌群失调"],
...
[
  ...
  {"name": "HEC Pharm 东阳光药", "ticker": "1558.HK", "market": "hk", "tier": 2, "lines": ["L1", "L9"],
   "note": "1558 is not in HKEX's active-securities list (checked 2026-09-16); the listed entity may have been renamed or re-coded -- confirm the current code before this entry can be collected"},
